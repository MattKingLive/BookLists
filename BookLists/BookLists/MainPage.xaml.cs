...
namespace BookLists
{
	public partial class MainPage : ContentPage
	{
        ...
        private void MicrosoftBooks_Clicked(object sender, EventArgs e) => Navigation.PushAsync(new Microsoft());
        private void Programming_Clicked(object sender, EventArgs e) => Navigation.PushAsync(new Microsoft());
